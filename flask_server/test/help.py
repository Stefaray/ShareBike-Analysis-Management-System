...
'''0~1037'''
for i in range(17753,17754):
    user=User(i,datetime(2016,randint(1,12),randint(1,28),randint(0,23),randint(0,59),randint(0,59)),
              '用户'+getRandomName(),"123456",Identity.ordinary,phone=genPhone(),money=99,email=genEmail())
